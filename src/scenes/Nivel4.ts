   ...
   // public controladorEscena:ControlDeEscenas
	...
	preload()
     ...
     {    
        ...
        7
        /// carrito
        this.load.image('carritoParado', 'imagenes/sprites/carritoParado.png');
    ...
    {   
     ...
     if (this.EstadoMusica=="1") {
       ...
       //let musicaFondo=this.sound.add('musicaMenu').play()
        ...
        this.map= this.make.tilemap({key:'tilemap4'}) /// tiene que estar seleccionada en tiled la opcion empotrar en mapa y ponerle nombre.     
                   ...
                   .setData('colisionando',false)
                    ...
                    case 'cajas':
        
                        {
                           ...
                           const cajas= this.matter.add.sprite(x, y,'caja', undefined, {
                            isStatic: true//,
                          //  isSensor: true
                        })
                       .setScale(0.3)
...
this.GrupoCarritos.forEach (carrito => carrito.mueveCarritosX())
